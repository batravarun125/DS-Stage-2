...
arr_count = 1
csv = open("Table1_2_2-3.csv", "w", encoding='utf=8')
...
while mainPage.status_code == 200:
    ...
    # print(parsed)
    mainPage.close()
    books = parsed.findAll("div", {"class":"sg-col-4-of-12 sg-col-8-of-16 sg-col-16-of-24 sg-col-12-of-20 sg-col-24-of-32 sg-col sg-col-28-of-36 sg-col-20-of-28"})
    ...
    for i in range(0,len(books)):
        ...
        print("Rating: " + rating)
        price = books[i].find("span", {"class":"a-price-whole"})
